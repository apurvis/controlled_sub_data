...
ActiveRecord::Schema.define(version: 20160517035030) do
  ...
  add_index "substance_classifications", ["deleted_at", "name", "schedule_level"], name: "idx_deleted_name_level", unique: true, using: :btree
